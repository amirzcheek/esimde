export default function LandingFooter() {
  return (
    <footer className="flex items-center w-full bg-blue-50 py-10" id="contacts">
      <div className="flex items-start container max-w-7xl mx-auto px-4 flex-wrap gap-8">
        {/* Logo */}
        ...
        <div className="w-full md:w-auto flex flex-col md:flex-row gap-8 ml-0 md:ml-auto">
          <div className="flex flex-col">
            ...
            <div className="flex items-center mb-2 gap-2">
              <svg className="text-blue-400 w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="tel:87718347530" className="text-gray-800 hover:text-blue-500 border-b border-dashed text-sm">87718347530</a>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-start gap-2 text-sm">
              <svg className="text-blue-400 w-5 h-5 flex-shrink-0 mt-0.5" viewBox="0 0 24 24" fill="currentColor">
