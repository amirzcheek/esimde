      ...
      <section className="container max-w-3xl mx-auto py-6 px-4">
        <div className="bg-white p-5 sm:p-6 rounded-2xl shadow-lg border border-gray-200">
          ...
          <div className="text-gray-700 text-sm leading-relaxed mb-6">
            {score >= 90
              ? 'Ваше здоровье требует постоянного внимания. Рекомендуем пройти полную версию теста, чтобы узнать о факторах которые могут повлиять на ваше когнитивное здоровье в будущем.'
              : score >= 65
              ? 'Рекомендуем пройти полную версию теста для получения более точных данных и выявления возможных факторов риска когнитивного снижения.'
              : 'Это важная информация. Для точного определения нарушений рекомендуется пройти полное тестирование у специалиста.'
            }
          </div>
